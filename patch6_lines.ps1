...
$lines = [System.IO.File]::ReadAllLines("C:\Users\PC\Desktop\APP開發\index.html", $utf8)
...
# The block itself
$newLines.Add($newJSBlock)

# 4755 to end (inclusive)
for ($i = 4755; $i -lt $lines.Length; $i++) {
    $newLines.Add($lines[$i])
}

[System.IO.File]::WriteAllLines("C:\Users\PC\Desktop\APP開發\index.html", $newLines, $utf8)
